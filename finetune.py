...
def train(
    # model/data params
    base_model: str = "./data/llm_models/llama-2-13b-chat-hf",  # the only required argument
    data_path: str = "./sft_data/instructions.json",
    output_dir: str = "./data/llm_models/llama-2-13b-finetune",
...
def generate_prompt(data_point):
    ...
    if data_point["input"]:
        return f"""Below is an instruction that describes knowledge graph construction task, paired with an input that provides further context. Write a response that appropriately completes the request.
